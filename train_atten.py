...
def arg_pare():
	...
	arg.add_argument('--modeldir', help=' the model viz dir ', default='atten_res')
...
def main():
	...
	model=resnet18(pretrained=True,num_classes=200).cuda()
	LR = Learning_rate_generater('step', [40,60], args.epochs)
