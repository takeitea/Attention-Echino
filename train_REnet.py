...
from loss import list_loss, ranking_loss, MultiLoss,KL_Loss,Auxiliary_Loss_Seq
...
def arg_pare():
	...
	arg.add_argument('--epochs', default=17)
	...
	arg.add_argument('--modeldir', help=' the model viz dir ', default='train_darkn_lstm_padding_aug_softmax')
...
def main():
	...
	LR = Learning_rate_generater('step', [7, 12], args.epochs,args)
	# LR.plot_lr()
